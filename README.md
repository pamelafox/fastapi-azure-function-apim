...
4. Click [http://localhost:7071/](http://localhost:7071/) in the terminal, which should open the website in a new tab.
...
6. To get a subscription key for API calls, navigate to the portal URL from the output, open the _Subscriptions_ page from the side nav, and copy one of the built-in keys.
